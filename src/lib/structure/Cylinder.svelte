...
<T.Mesh {position} {rotation} scale={[thickness, height, thickness]} raycast={null} frustumCulled={!transparent}>
  <T.CylinderGeometry args={[thickness, thickness, 1, 8]} />
  <T.MeshStandardMaterial {color} {transparent} {opacity} {depthTest} depthWrite={!transparent} />
</T.Mesh>
