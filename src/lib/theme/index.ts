// Theme System for CatGo

const is_browser = typeof window !== `undefined`
const storage_key = `catgo-theme`
...
export const apply_theme_to_dom = (mode: ThemeMode): void => {
  ...
  const theme = globalThis.CATGO_THEMES?.[resolved] || {}
  const css_vars = globalThis.CATGO_CSS_MAP || {}
...
// Theme getters
export const light_theme = () => globalThis.CATGO_THEMES?.[COLOR_THEMES.light] || {}
export const dark_theme = () => globalThis.CATGO_THEMES?.[COLOR_THEMES.dark] || {}
export const white_theme = () => globalThis.CATGO_THEMES?.[COLOR_THEMES.white] || {}
export const black_theme = () => globalThis.CATGO_THEMES?.[COLOR_THEMES.black] || {}
export const get_theme_by_name = (name: ThemeName) =>
  globalThis.CATGO_THEMES?.[name] || {}
